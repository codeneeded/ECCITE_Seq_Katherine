...
#Check effect of Stim
png(file="PCA_by_Cell_Cycle_Split_by_phasae_groupby_stim.png", width = 900, height = 600)
DimPlot(seurat_phase,
        reduction = "pca",
        group.by= "stim",
        split.by = "Phase")
...
png(file="PCA_by_Cell_Cycle_Split_by_phasae_groupby_phase.png", width = 900, height = 600)
DimPlot(seurat_phase,
        reduction = "pca",
        group.by= "Phase",
        split.by = "stim")
...
samples <-  c("P1042MED", "P1042CD3", "P1042HIV", "P1043MED", "P1043CD3", "P1043HIV", "JLKMED", "JLKCD3")
